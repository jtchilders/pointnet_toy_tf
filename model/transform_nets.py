...
# taken from https://github.com/charlesq34/pointnet/blob/master/models/transform_nets.py
...
def input_transform_net(point_cloud, is_training, bn_decay=None, K=3):
    ...
    net = tlh.max_pool2d(net, [num_point,1],
                             padding='VALID', scope='tmaxpool')

    net = tf.reshape(net, [batch_size, -1])
    net = tlh.fully_connected(net, 512, bn=True, is_training=is_training,
                                  scope='tfc1', bn_decay=bn_decay)
    net = tlh.fully_connected(net, 256, bn=True, is_training=is_training,
